  ...
  return (
    <div className="home-container">
      ...
      <div className="fashion-carnival-banner">
        <div className="banner-container">
          <div className="banner-half">
            ...
            />
            <a href="/mens" className="banner-button him-button">
              <span className="icon-text">HIM</span>
          ...
          <div className="banner-half">
            <img
              ...
              className="half-banner-image"
            />
            <a href="/womens" className="banner-button her-button">
              <span className="arrow-icon">❮</span>
              <span className="icon-text">HER</span>
            </a>
          </div>
        </div>
      </div>
      ...
      <div className="home-content">
        ...
        a<div className="deals-section">{/* Your deals would go here */}</div>
      </div>
    </div>
  );
};
